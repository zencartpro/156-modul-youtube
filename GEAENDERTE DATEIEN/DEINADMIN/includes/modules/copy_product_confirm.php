 ...
 * @version $Id: copy_product_confirm.php for YouTube 2019-07-13 08:11:16Z webchills $
 */
...
// Copy attributes to duplicate product
  ...
  if ($_POST['copy_as'] == 'link') {
    ...
    $db->Execute("INSERT INTO " . TABLE_PRODUCTS . " (products_type, products_quantity, products_model, products_image, products_youtube,
